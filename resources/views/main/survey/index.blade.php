      ...
      <div class="px-lg-20 mx-lg-20 mt-10 mb-20">
        <div class="d-md-flex flex-stack mb-5">
          ...
          <form method="GET" class="d-flex justify-content-between">
            ...
            <button class="btn btn-danger btn-icon ms-3" type="submit" id="button-addon2">
                  ...
                  <div class="col-md-6 col-lg-3 pb-10">
                    <div class="card-xl-stretch me-md-6">
                      ...
                      <div class="m-0">
                        ...
                        <a href="{{ route('survey.show', $item->slug) }}" class="fs-4 text-gray-900 fw-bold text-hover-danger text-gray-900 lh-base">{{ $item->title }}</a>
                        <div class="mt-5">
                          <a href="{{ route('survey.show', $item->slug) }}" class="btn btn-danger">Isi Kuisioner</a>
                        </div>
                      </div>
                    </div>
                  </div>
