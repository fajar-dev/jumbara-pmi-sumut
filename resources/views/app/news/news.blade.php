      ...
      <div class="card card-flush">
        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
          ...
          <div class="card-toolbar">
            ...
            <a href="{{ route('admin.news.add') }}" class="btn btn-danger d-flex align-items-center"><i class="ki-duotone ki-plus fs-2"></i>
              Add
            </a>
          </div>
        </div>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex align-items-center">
                          ...
                          <div class="ms-5">
                            <a href="{{{ route('news.show', $item->slug) }}}" target="_blank" class="text-gray-800 text-hover-danger fs-5 fw-bold mb-1">{{ $item->title }}</a>
                      ...
                      <td>
                        <div class="text-start">
                          <div class="fs-6 fw-bold">
                            <span class="badge badge-light-danger">{{ $item->newsCategory->name }}</span>
                          </div>
                        </div>
                      </td>
                      <td>
                      ...
                      <td class="text-end">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                          <div class="menu-item px-3">
                            <a href="{{ route('admin.news.edit', $item->id) }}" class="menu-link px-3 text-hover-danger bg-hover-light">Edit</a>
                          </div>
                          <div class="menu-item px-3">
                            <a id="{{ route('admin.news.destroy', $item->id) }}" class="menu-link px-3 text-hover-danger bg-hover-light btn-del">Delete</a>
                          </div>
                        </div>
                      </td>
                    </tr>
