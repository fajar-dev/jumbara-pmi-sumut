        ...
        <div class="card-body pt-0">
                    ...
                    <tr>
                      ...
                      <td class="text-end">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                          ...
                          <div class="menu-item px-3">
                            <a id="{{ route('admin.category.destroy', $item->id) }}" class="menu-link text-hover-danger bg-hover-light px-3 btn-del">Delete</a>
                          </div>
                        </div>
                      </td>
                    </tr>
          ...
          <div class="d-flex flex-stack flex-wrap my-3">
            ...
            <ul class="pagination">
              ...
              @else
                  <li class="page-item previous">
                      <a href="{{ $category->previousPageUrl() }}" class="page-link bg-light text-hover-danger"><i class="previous"></i></a>
                  </li>
              @endif
              ...
              @foreach ($category->getUrlRange($start, $end) as $page => $url)
                  <li class="page-item{{ ($page == $category->currentPage()) ? ' active' : '' }}">
                      <a class="page-link {{ ($page == $category->currentPage()) ? ' bg-danger' : 'text-hover-danger' }}" href="{{ $url }}">{{ $page }}</a>
                  </li>
              @endforeach
              ...
              @if ($category->hasMorePages())
                  <li class="page-item next">
                      <a href="{{ $category->nextPageUrl() }}" class="page-link bg-light text-hover-danger"><i class="next"></i></a>
                  </li>
              @else
                  <li class="page-item next">
