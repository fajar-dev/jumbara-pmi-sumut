              ...
              <div id="kt_signin_email_edit" class="flex-row-fluid d-none">
                <form action="{{ route('app.profile.signin') }}" id="formSignin" method="POST" class="form">
                  ...
                  <div class="d-flex">
                    ...
                    <button id="kt_signin_cancel" type="button" class="btn btn-color-gray-500 btn-active-light-danger px-6">Cancel</button>
                  </div>
                </form>
              </div>
              ...
              <div id="kt_signin_password_edit" class="flex-row-fluid d-none">
                <form id="formPassword" method="POST" action="{{ route('app.profile.change-password') }}" class="form">
                  ...
                  <div class="d-flex">
                   ...
                   <button id="kt_password_cancel" type="button" class="btn btn-color-gray-500 btn-active-light-danger px-6">Cancel</button>
                  </div>
                </form>
              </div>
