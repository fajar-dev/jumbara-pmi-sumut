...
<div class="position-fixed bottom-0 end-0 mt-5 me-5" style="z-index: 9999;">
  <div class="toast align-items-center bg-danger" id="success" role="alert" aria-live="assertive" aria-atomic="true">
    <div class="d-flex">
  ...
  <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
    <div class="modal-content shadow rounded ">
      <div class="modal-body p-4 text-center py-8">
        ...
        <p class="mb-0">Are you sure to delete this data?</p>
      </div>
